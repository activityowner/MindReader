...
End Type
        ...
        Sub Marktaskcomplete(ByRef m_app As Mindjet.MindManager.Interop.Application)
            ...
            configdoc = getmap(configmapname)
            ...
            For i = 1 To scount
                ...
                Else 'isdb
                    For Each tt In doccurrent.Range(mmRangeAllTopics)
                        ...
                        End If
                    Next
                    t = followedhyperlink(t, doccurrent)
        ...
        Function LoadDefaultOptions(ByRef configdoc As Document) As myoptiontype
            ...
            With LoadDefaultOptions
                ...
                .logname = .logbasename & Year(Of Date)() & "-" & Month(Of Date)() & ".mmap"
        ...
        End Function
        Function optionlocal(ByRef setting, ByRef rnotes As String, ByVal oDefault As Boolean) As Boolean
		...
		ElseIf InStr(rnotes,setting&"=1")>0 Then
            ...
            End If
        End Function
        Function advancetask(ByRef t As Topic, ByRef changedates As Boolean, ByVal configdoc As Document) As Boolean
                ...
                For Each codetopic In a.AllSubTopics
                    If InStr(cats, codetopic.Text) > 0 Then
                        ...
                        If changedates Then
                            ...
                            If Not datefixed And hasstart Then setstartdate(t, DateAdd(units, inc, Today) - lead)
                            If sdd And Not hasstart Then setstartdate(t, DateAdd(units, inc, Today) - lead)
                ...
                For Each codetopic In a.AllSubTopics
                    If InStr(LCase(cats), LCase(codetopic.Text)) > 0 Then
                        ...
                        If changedates Then
                            ...
                            If d > 0 Then
                                t.Task.DueDate = IIf(Weekday(Today) <= 1, Today + d - Weekday(Today), Today + d - Weekday(Today) + 7)
                ...
                If InStr(LCase(cats), getoption("endofmonthcode", configdoc)) > 0 Or InStr(LCase(cats), getoption("endofquartercode", configdoc)) > 0 Then
                    ...
                    If changedates Then
                        If InStr(cats, getoption("endofmonthcode", configdoc)) > 0 Then
                            ...
                            Else
                                If sdd Then t.Task.DueDate = DateAdd("m", 2, Today) - Day(Of Date)() - 1
                            End If
        ...
        Sub movetocompletedtopic(ByRef t As Topic, ByRef doccurrent As Document, ByRef opt As myoptiontype)
            ...
            End If
        End Sub
        Sub copytocompletedtopic(ByRef t As Topic, ByRef doccurrent As Document, ByVal opt As myoptiontype)
            Dim completedtopic As Topic
            Dim tt As Topic
            If Not t.IsCentralTopic Then
                completedtopic = createcompletedtopic(doccurrent, t, opt)
        ...
        Sub Upgrade(ByRef configdoc As Document)
            ...
            If RunUpgrade Then
                ...
                createoption("lastversioncheck", Str(Of Date), configdoc)
